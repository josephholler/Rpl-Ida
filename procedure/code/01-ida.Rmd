...
**Note:** Twitter (now X) no longer offers a free API for pulling large searvch queries of tweets. For this study, I used tweets that were already downloaded from Twitter.
